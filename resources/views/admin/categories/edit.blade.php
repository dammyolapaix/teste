        ...
        <section class="no-padding-top">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong class="d-block">Editar categoria</strong></div>
                  <div class="block-body">

                    <form action="{{route('categoria.update', ['id' => $category->id])}}" method="POST" enctype="multipart/form-data">
